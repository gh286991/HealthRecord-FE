    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      <div className="mb-6">
        <div className="flex items-end gap-3 flex-wrap">
          <h1 className="text-3xl font-bold text-gray-900">{heading || '使用者條款（Terms of Service）'}</h1>
          {latestVersion && (
      ...
      <div className="text-center py-4 text-sm text-gray-500 border-t border-gray-100 mt-8 pt-4">
        如需查看最新條款，請訪問 <Link href="/terms/latest" className="text-orange-600 hover:text-orange-700">/terms/latest</Link>
      </div>
    </div>
  );
}
